                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
						...
						<li class="sidebar-item">
							...
							<ul aria-expanded="false" class="collapse  first-level">
								<li class="sidebar-item"><a class="sidebar-link" href="add_fields.php"><i class="fab fa-elementor"></i><span class="hide-menu"> Add Fields</span></a></li>
						...
						<li class="sidebar-item"><a class="sidebar-link waves-effect waves-dark " href="logout.php"><i class="fas fa-sign-out-alt"></i><span class="hide-menu"> Logout</span></a></li>
                    </ul>
                </nav>
